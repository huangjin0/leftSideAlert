...
- (void)viewDidLoad {
    ...
    UIViewController*left=[self.storyboard instantiateViewControllerWithIdentifier:@"left"];
    UIViewController*main=[self.storyboard instantiateViewControllerWithIdentifier:@"main"];
    
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(notifi) name:@"left" object:nil];
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(notifiClose:) name:@"CloseLeft" object:nil];
    [self initWithLeftView:left andMainView:main];
...
-(void)notifiClose:(NSNotification*)notification
{
    NSLog(@"%@",notification);
  UIViewController*controller=(UIViewController*)[notification.userInfo valueForKey:@"vc"];
    
   [self closeLeftView];
//    if (controller!=nil) {
//    [self presentViewController:controller animated:YES completion:nil];//:controller animated:YES];
//    }
    [self.mainVC pushViewController:controller animated:NO];
}
...
-(void)awakeFromNib
{
    NSLog(@"awakeFromNib:%@%@",self.leftVC,self.mainVC);
...
- (void)initWithLeftView:(UIViewController *)leftVC
